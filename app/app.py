...
def apply_watermark():
    ...
    qr_req_url = f"https://qrackajack.expeditedaddons.com/?api_key={QRACKAJACK_API_KEY}" \
                 f"&content={img_url}"
    ...
    watermark_req_url = f"https://watermarker.expeditedaddons.com/?api_key={WATERMARKER_API_KEY}" \
